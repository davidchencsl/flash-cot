...
def prepare_arc_data():
    easy_train_df = pd.read_parquet("llm-route/dataset/ai2_arc/ARC-Easy/train-00000-of-00001.parquet")
    easy_val_df = pd.read_parquet("llm-route/dataset/ai2_arc/ARC-Easy/validation-00000-of-00001.parquet")
    easy_test_df = pd.read_parquet("llm-route/dataset/ai2_arc/ARC-Easy/test-00000-of-00001.parquet")
    # print(easy_train_df.shape)
    # print(easy_val_df.shape)
    # print(easy_test_df.shape)

    hard_train_df = pd.read_parquet("llm-route/dataset/ai2_arc/ARC-Challenge/train-00000-of-00001.parquet")
    hard_val_df = pd.read_parquet("llm-route/dataset/ai2_arc/ARC-Challenge/validation-00000-of-00001.parquet")
    hard_test_df = pd.read_parquet("llm-route/dataset/ai2_arc/ARC-Challenge/test-00000-of-00001.parquet")
...
def process_data(easy_df_list, hard_df_list):
    easy_data = process_label(easy_df_list[2], 0)
    hard_data = process_label(hard_df_list[2], 1)
    # print(easy_data[:10])
    # print(hard_data[:10])
